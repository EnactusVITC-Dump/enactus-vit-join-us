//#region node_modules/.nitro/vite/services/ssr/assets/departments-CR7h14e2.js
var departments = [
	{
		id: "tech",
		...
		description: "Ships the websites, internal tools and digital products that carry our projects to the world.",
		responsibilities: [
	...
	},
	{
		...
		description: "Turns fieldwork into films, posters and campaigns that make people care about the work.",
		responsibilities: [
	...
	},
	{
		...
		name: "Finance",
		shortName: "Finance",
		tagline: "Manages budgets and funding",
		description: "Drafts project budgets, manages financial resources, and ensures sustainability for all our on-ground initiatives and events.",
		responsibilities: [
			"Draft project and event budgets",
			"Track expenses and ensure cashflow health",
			"Assess financial viability of social ventures"
		]
	},
	{
		id: "operations",
		...
		description: "Runs logistics, timelines and field execution so ideas move from a document to a village, campus or market.",
		responsibilities: [
	...
	},
	{
		...
		description: "Opens doors — sponsors, partners, alumni and media — and keeps the outside world invested in us.",
		responsibilities: [
...
var departmentMap = departments.reduce((acc, d) => ({
	...acc,
	[d.id]: d
}), {});
var whyJoin = [
...
//#endregion
export { departments as n, whyJoin as r, departmentMap as t };
